...
public class GameManager {
    ...
    public void initializeDefaultCrew() {
        ...
        storage.addCrewMember(new Pilot(0,""));
        storage.addCrewMember(new Engineer(0,""));
        storage.addCrewMember(new Medic(0,""));
        storage.addCrewMember(new Scientist(0,""));
        storage.addCrewMember(new Soldier(0,""));
    }
